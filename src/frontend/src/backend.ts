...
import type { Cell as _Cell, Error as _Error, Listing as _Listing, ListingStatus as _ListingStatus, Order as _Order, OrderStatus as _OrderStatus, Platform as _Platform, Result as _Result, Result__1 as _Result__1, Stats as _Stats, UserRole as _UserRole, Value as _Value } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async completeOrder(arg0: bigint): Promise<Order | null> {
        if (this.processError) {
            try {
    ...
    async createListing(arg0: string, arg1: string, arg2: Platform, arg3: string, arg4: bigint, arg5: Stats, arg6: bigint, arg7: Array<string>): Promise<Listing> {
        if (this.processError) {
            try {
                const result = await this.actor.createListing(arg0, arg1, to_candid_Platform_n14(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5, arg6, arg7);
    ...
    async listBuyerOrders(): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.listBuyerOrders();
    ...
    async placeOrder(arg0: bigint): Promise<Order | null> {
        if (this.processError) {
            try {
    ...
    async updateListing(arg0: bigint, arg1: string, arg2: string, arg3: Platform, arg4: string, arg5: bigint, arg6: Stats, arg7: bigint, arg8: Array<string>): Promise<Listing | null> {
        if (this.processError) {
            try {
                const result = await this.actor.updateListing(arg0, arg1, arg2, to_candid_Platform_n14(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6, arg7, arg8);
                return from_candid_opt_n30(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Listing]): Listing | null {
...
function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        platform: from_candid_Platform_n12(_uploadFile, _downloadFile, value.platform),
        seller: value.seller,
...
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "placed" in value ? OrderStatus.placed : "completed" in value ? OrderStatus.completed : value;
}
...
function to_candid_Platform_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Platform): _Platform {
...
function to_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Platform): {
    pc: null;
} | {
    xbox: null;
} | {
